...
namespace FastNetwork
{
    ...
    public sealed class SocketListener : ISocketListener
    {
        ...
        public SocketListener(string name, IPEndPoint endPoint, IHost host)
        {
        ...
        /// </summary>
        public event Action<ISocketListener, IConnection> Accepted;
        /// <summary>
        /// get listener name
        /// </summary>
        public string Name
        ...
        private void AcceptAsyncCompleted(object sender, SocketAsyncEventArgs e)
        {
            ...
            if (acceptedSocket != null)
            {
                ...
                this.Accepted(this, new DefaultConnection(this._host.NextConnectionID(), acceptedSocket, this._host));
            }
